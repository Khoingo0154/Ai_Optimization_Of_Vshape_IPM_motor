#!/usr/bin/env python3
# motor_optimizer_ver5.2(fix lan3)_oneSixth_remote.py
"""
Version 5.2 (Fix Lan 3) - oneSixth variant of the AI Optimizer for the V-Shape IPM Motor.
Uses the 1/6-sector symmetry project file `Matlab_Ai_Optimization_oneSixth.aedt`
(saved by Ansys 2026.1, Multiplier=6) instead of the full 360-deg model.
Requires Ansys Electronics Desktop 2026.1 or newer to open the project.
...
def run_ansys_direct(population: List[Dict], 
    ...
    """
    project_path = root_dir / "Matlab_Ai_Optimization_oneSixth.aedt"
